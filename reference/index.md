...
Functions to estimate cancer projections using the various methods
...
Helper functions to work with outputs from model fitting functions.
...
Tools for creating and working with standard populations.
